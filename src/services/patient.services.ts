...
export const savePatientInformation = async(data:any) => {
    ...
    try {
        var response = await axios({
            method: 'PUT',
            url: `https://${url}/patients/${data.patientID}/`,
            responseType: 'json',
            data: normalizedData,
            headers: {
...
export const createPatient = async(data:any) => {
    ...
    try {
        ...
        if (dataWithoutProfilePic) {
            response = await axios({
                method: 'PUT',
                url: `https://${url}/patients/${responseData.patientID}/`,
                data: dataWithoutProfilePic,
                headers: {
                    'Authorization': `Bearer ${accessToken}`        
                },
...
export const fetchComments = async(patientID: any) => {
    ...
    try {
        const response = await axios({
            method:'GET',
            url: `https://${url}/patients/${parseInt(patientID)}/comments/`,
            responseType: 'json',
            headers: {
                'Authorization': `Bearer ${accessToken}`        
            },
...
export const createComments = async(data: any) => {
    ...
    try {
        const response = await axios({
            method:'POST',
            url: `https://${url}/patients/${patientID}/comments/`,
            headers: {
                "Content-Type": "multipart/form-data; boundary=--------------------------907931495521859766893792",
                'Authorization': `Bearer ${accessToken}`        
            },
...
export const editComments = async(data: any) => {
    ...
    try {
        const response = await axios({
            method:'PUT',
            url: `https://${url}/comments/${commentID}/`,
            responseType: 'json',
            data: formData,
            headers: {
                'Authorization': `Bearer ${accessToken}`        
...
export const fetchPatientInformation = async(patientID: any) => {
    ...
    try{
        const response = await axios({
            method: 'GET',
            url: `https://${url}/patients/${parseInt(patientID)}/`,
            responseType: 'json',
            headers: {
                'Authorization': `Bearer ${accessToken}`        
            },
...
export const fetchReport = async(reportID: string) => {
    ...
    try{
        const response = await axios({
            method: 'GET',
            url: `https://${url}/patienthealthrecords/?search=${reportID}`,
            responseType: 'json',
        });
...
export const generateObesityPrediction = async(data: any) => {
    try {
        ...
        const response:any = await axios({
            method: 'POST',
            responseType: 'json',
            url: `https://${url}/obesity/v1/comorbidities_classifier/predict`,
            data: normalizedData,
...
export const setPatientandFeedbackMLRequest = async(data: any) => {
    ...
    try {
        const response = await axios({
            method: 'PUT',
            url: `https://${url}/obesity/v1/mlrequests/${data.reportID}`,
            data: tempData,
            responseType: 'json',
            headers: {
                'Authorization': `Bearer ${accessToken}`
...
export const fetchAllObesityPredictionReport = async(patientID: any) => {
    ...
    try {
        const response = await axios({
            method: 'GET',
            url: `https://${url}/obesity/v1/mlrequests`,
            responseType: 'json',
            headers: {
                'Authorization': `Bearer ${accessToken}`
            }
...
export const fetchObesityPredictionReport = async(reportID: any) => {
    ...
    try {
        const response = await axios({
            method: 'GET',
            url: `https://${url}/obesity/v1/mlrequests/${reportID}`,
            responseType: 'json',
            headers: {
                'Authorization': `Bearer ${accessToken}`
            }

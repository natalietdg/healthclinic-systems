...
import { fetchImage } from 'Services/patient.services';
            ...
            (async function () {
                ...
                if (blob instanceof Blob) {
                    ...
                    if (typeof(blob)=='string') {
                        if(blob!='') {
                            const res:any = fetchImage(blob);
                            if(res.error) { setImgUrl('data:image/png;base64,')}
                            else setImgUrl(blob);
                        }
                    }
                    else if(blob?.image) {  
        ...
        <div className="image-upload">
            ...
            
            {
                disabled ==false && <label className="image-upload--input" >
                    <input aria-label={t(`label.${name}`)} hidden multiple={false} type="file" accept="image/png, image/jpeg" onChange={(e) => handleChange(e)}/>
                    Choose File
                </label>
            }
        </div>

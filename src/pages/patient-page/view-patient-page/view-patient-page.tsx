             ...
             <Toaster toasterID="viewPatient-toaster" style={{...styles.fadeInRight}} props={toasterProps}/>
             {
                   ...
                   <Radium.StyleRoot style={{width: '88%',  display: 'flex'}}>
                    <Container flexDirection='column' alignItems='flex-start' style={{...styles.fadeIn}}>
                    {
                        patientInformation && 
                        <div style={{width: '100%'}}>
                            <h2>{patientInformation.fullName}</h2>
                            <Row>
                                <div style={{width: 'inherit'}}>
                                    ...
                                    <div className="content-container">
                                        ...
                                        <span className="span">
                                            <h4 className="span--title">Reason for Consultation</h4>
                        ...
                        <div style={{width: '100%'}}>
                                ...
                                patientInformation.obesityPredictionReports.map((predictionReport: any, index:number) => {
                                    ...
                                    return (
                                        <Row>
                                            <div style={{width: 'inherit'}}>
                                                <div style={{display: 'flex', justifyContent: 'flex-start', alignItems: 'center'}}>
                                                    <h4 className="span--title">{new Date(predictionReport.created).toLocaleDateString([], {
                                                        year: 'numeric',
                                                        month: 'long',
                                                        day: 'numeric'
                                                    })}</h4>
                                                ...
                                                {/* {
                                                    ...
                                                    return (
                                                        <span className="span">
                                                            ...
                                                            <h4 className='span--text'>{predictionReport?.fullResponse?.probability[name]}%</h4>
                                                        </span>)
                                                    })
                                                } */}
                                                <div style={{padding: '30px', display: 'flex', justifyContent: 'flex-start'}}>
                                                    <Table 
                                                        columns={[
                            ...
                            <Row>
                                <div style={{width: 'inherit'}}>
                                    <div style={{display: 'flex', justifyContent: 'flex-start', alignItems: 'center'}}>
                                        <h3 className="title">Diagnosis & Comments</h3>
                                        ...
                                        patientInformation?.comments && patientInformation?.comments.map((comment: any, index: any) => {
                                            return (
                                                <Row key={index} style={{justifyContent:'flex-start'}}>
                                                    ...
                                                    <span className="span">
                                                        <h4 className="span--title">{new Date(comment?.created).toLocaleDateString([], {
                                                            year: 'numeric',
                                                            month: 'long',
                                                            day: 'numeric'
                                                        })} - {comment?.diagnosis}</h4>
